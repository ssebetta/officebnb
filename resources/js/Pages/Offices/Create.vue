...
const submit = () => {
    ...
    form.transform(() => data).post(route('listings.store'), {
        onError: (errors) => {
...
<template>
    <AppLayout title="Create listing">
        <template #header>
            <div>
                <h2 class="text-xl font-semibold text-gray-900">Create a listing</h2>
                <p class="text-sm text-gray-500">Share your workspace with teams looking for flexible stays.</p>
            </div>
        </template>
            ...
            <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                <form class="space-y-6" @submit.prevent="submit">
                    ...
                    <div class="rounded-2xl bg-white p-6 shadow-sm">
                        ...
                        <div class="mt-6">
                            <label class="text-xs font-semibold uppercase tracking-wide text-gray-500">Or upload images</label>
                            <input 
                                type="file" 
                                accept="image/*" 
                                multiple 
